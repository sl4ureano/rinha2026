...
export default function () {
    ...
    // Dentro do container do LB use BASE_URL=http://127.0.0.1:9999
    // No host Windows use a rede do LB (ver README) — localhost mede ~70ms de p99.
...
export function handleSummary(data) {
    ...
    const resultsFile = __ENV.RESULTS_FILE || 'results.json';
    return {
        [resultsFile]: JSON.stringify(result, null, 2),
